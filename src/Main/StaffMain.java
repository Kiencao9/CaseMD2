...
public class StaffMain {
    ...
    public static void staffMain() {
        while (true) {
            ...
            System.out.println("*   6. Hiển thị tất cả nhân viên Full Time đang làm việc  *");
            System.out.println("*   7. Hiển thị tất cả nhân viên Part Time đang làm việc  *");
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    managerStaffPartTime.displayByStatusON();
                    break;
                case 0:
                    return;
            }
